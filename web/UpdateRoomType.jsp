       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
                        ...
                        <form class="form-horizontal" method="post" action="UpdateRoomType">
                            <%
                                RentHouseModel buku = new RentHouseModel();  
                                ResultSet rs;
                                 String idcustomer = request.getParameter("idRoomType");
                                         if(!((idcustomer)== null))
                                         {
                                             rs = buku.findRoomType(idcustomer);
                                             if (rs.next()) 
                                             {
                                          %>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<% out.println(rs.getString("id_room_type")); %>" name="idroomtype" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
