           ...
           public String autoIDKomen()
            {
                try
                {
                    ...
                    String sql = "select top 1 id_transaction from transactionn order by id_transaction desc";
                    Statement state = con.createStatement();
                     ...
                     if (rs.next())
                     {
                         ...
                         int cut = Integer.parseInt(result.substring(1)) + 1 ;
                         if (cut<10)
                         {
                             nextid = "P00" + cut;
                         }
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
					...
					<div class="grid-form1">
                        <h3 id="forms-horizontal">Rent In</h3>
                        <form class="form-horizontal" method="post" action="RentIn"/>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">ID Transaction</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<%= autoIDKomen()%>" name="idtransaction" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Room Type</label>
                            <div class="col-sm-10">
                                <select  Class="form-control" name="idcustomer" >
                                    <% 
                        RentHouseModel n = new RentHouseModel();
                            String CategoryID = "";
                            String Category = "";
                            try
                            {
                                 ArrayList data_client = n.getCustomerCombo();
                        ...
                        %>                    
                          ...
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Room</label>
                            <div class="col-sm-10">
                            ...
                            try
                            {
                                 ArrayList data_client2 = n.getRoomAvailable();
                                 for(int i = 0; i < data_client2.size(); i+=2)
                                 {
                                     CategoryID2 = (String)data_client2.get(i);
                                    Category2 = (String)data_client2.get(i+1);
                        %>
                        <option value="<%=CategoryID2%>"><%=Category2%></option>
                        <%
                                 }
                        ...
                        <hr />
                          <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" Class="btn btn-default" Text="Save"/>Submit</button>
                            </div>
                          </div>
                        </form>
                     </div>
