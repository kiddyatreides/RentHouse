...
<html>
<head>
<title>Rent House Admin Panel | Transaction List</title>
                                    ...
                                    <table class="table table-striped table-bordered data">
                                            ...
                                            <tbody>
                                                 <%
                                                        ...
                                                        String sql = "select a.id_transaction,b.name as room,c.nama as customer,a.datein,a.dateout,a.status from transactionn a inner join room b on b.id_room = a.id_room inner join customer c on c.id_customer = a.id_customer where a.status = 'Rent In' order by id_transaction asc";
                                                    ...
                                                    <tr>				
                                                            ...
                                                            <td><% out.println(rs.getString("id_transaction")); %></td>
                                                            <td><% out.println(rs.getString("room")); %></td>
                                                            <td><% out.println(rs.getString("customer")); %></td>
                                                            <td><% out.println(rs.getString("datein")); %></td>
                                                            
                                                            <td><a href="RentOut?idTransaction=<% out.println(rs.getString("id_transaction")); %>" class="btn-sm btn-danger">Rent Out</a></td>
