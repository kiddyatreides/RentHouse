           ...
           public String autoIDKomen()
            {
                try
                {
                    ...
                    String sql = "select top 1 id_monthlypaid from monthlypaid order by id_monthlypaid desc";
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
					...
					<div class="grid-form1">
                        <h3 id="forms-horizontal">Add Monthly Paid</h3>
                        <form class="form-horizontal" method="post" action="AddMonthlyPaid"/>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">ID Monthly Paid Transaction</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<%= autoIDKomen()%>" name="idtransaction" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Transaction</label>
                            <div class="col-sm-10">
                                <select  Class="form-control" name="idtransactionn" >
                                    <% 
                        RentHouseModel n = new RentHouseModel();
                            ...
                            try
                            {
                                 ArrayList data_client = n.getTransaction();
                        ...
                        %>                    
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" Class="form-control" name="information" placeholder="Information" required=""></textarea>
                            </div>
                          </div>
