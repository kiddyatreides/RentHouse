...
<html>
<head>
<title>Rent House Admin Panel | Room List</title>
                                            ...
                                            <tbody>
                                                 <%
                                                    ...
                                                    <tr>				
                                                            ...
                                                            <td><% out.println(rs.getString("id_room")); %></td>
                                                            <td><% out.println(rs.getString("name")); %></td>
                                                            <td><% out.println(rs.getString("tipe")); %></td>
                                                            <td><% out.println(rs.getString("price")); %></td>
                                                            <td><% out.println(rs.getString("status")); %></td>
                                                            <td><a href="UpdateRoom?idRoom=<% out.println(rs.getString("id_room")); %>" class="btn-sm btn-danger">Update</a></td>
