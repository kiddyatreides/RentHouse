           ...
           public String autoIDKomen()
            {
                try
                {
                    ...
                    String sql = "select top 1 id_room from room order by id_room desc";
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
					...
					<div class="grid-form1">
                        <h3 id="forms-horizontal">Add Room Form</h3>
                        <form class="form-horizontal" method="post" action="AddRoom"/>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">ID Room</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<%= autoIDKomen()%>" name="idroom" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Name</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="name" placeholder="Name of Room"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                        ...
                        %>                    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" Class="form-control" name="price" placeholder="Price of Room"   required=""/>
                                </div>
                            </div>
                          </div>
                        <hr />
