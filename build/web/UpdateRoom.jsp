...
<html>
<head>
<title>Rent House Admin Panel | Update Room</title>
       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
                        ...
                        <form class="form-horizontal" method="post" action="UpdateRoom">
                            <%
                                RentHouseModel buku = new RentHouseModel();  
                                ResultSet rs;
                                 String idcustomer = request.getParameter("idRoom");
                                         if(!((idcustomer)== null))
                                         {
                                             rs = buku.findRoom(idcustomer);
                                             if (rs.next()) 
                                             {
                                          %>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<% out.println(rs.getString("id_room")); %>" name="idroom" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Name</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="nama" placeholder="Name of Customer"   required="" value="<% out.println(rs.getString("name")); %>"/>
                            </div>
                          </div>
                            <div class="form-group">
                        ...
                        %>                    
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="price" placeholder="Name of Customer"   required="" value="<% out.println(rs.getString("price")); %>"/>
                            </div>
                          </div>
                            <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Status</label>
                            <div class="col-sm-10">
                                <select Class="form-control" name="status" placeholder="Name of Customer"   required="">
