...
<html>
<head>
<title>Rent House Admin Panel | Monthly Paid List</title>
                                    ...
                                    <table class="table table-striped table-bordered data">
                                            ...
                                            <tbody>
                                                 <%
                                                        ...
                                                        String sql = "select * from monthlypaid";
                                                    ...
                                                    <tr>				
                                                            ...
                                                            <td><% out.println(rs.getString("id_monthlypaid")); %></td>
                                                            ...
                                                            <td><% out.println(rs.getString("info")); %></td>
