...
<html>
<head>
<title>Rent House Admin Panel | Add Customer</title>
					...
					<div class="grid-form1">
                        ...
                        <form class="form-horizontal" method="post" action="AddCustomer">
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<%= autoIDKomen()%>" name="idcustomer" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Name</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="nama" placeholder="Name of Customer"   required=""></asp:TextBox>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="cardnumber" placeholder="Number of Card"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Birthdate</label>
                            <div class="col-sm-3">
