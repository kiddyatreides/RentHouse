...
<html>
<head>
<title>Rent House Admin Panel | Customer List</title>
                                            ...
                                            <tbody>
                                                 <%
                                                    ...
                                                    <tr>				
                                                            ...
                                                            <td><% out.println(rs.getString("id_customer")); %></td>
                                                            <td><% out.println(rs.getString("nama")); %></td>
                                                            <td><% out.println(rs.getString("address")); %></td>
                                                            <td><% out.println(rs.getString("birthdate")); %></td>
                                                            <td><% out.println(rs.getString("phonenumber")); %></td>
                                                            <td><% out.println(rs.getString("card_type")); %></td>
                                                            <td><% out.println(rs.getString("card_number")); %></td>
                                                            <td><a href="UpdateCustomer?idCustomer=<% out.println(rs.getString("id_customer")); %>" class="btn-sm btn-danger">Update</a></td>
