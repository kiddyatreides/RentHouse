...
<html>
<head>
<title>Rent House Admin Panel | Update Customer</title>
       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
                        ...
                        <h3 id="forms-horizontal">Update Customer Form</h3>
                        <form class="form-horizontal" method="post" action="UpdateCustomer">
                            <%
                                ...
                                ResultSet rs;
                                 String idcustomer = request.getParameter("idCustomer");
                                         if(!((idcustomer)== null))
                                         {
                                             rs = buku.findCustomer(idcustomer);
                                             if (rs.next()) 
                                             {
                                          %>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<% out.println(rs.getString("id_customer")); %>" name="idcustomer" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Name</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="nama" placeholder="Name of Customer"   required="" value="<% out.println(rs.getString("nama")); %>"/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label hor-form">Card Type</label>
                            <div class="col-sm-10">
                                <select type="text" Class="form-control" name="cardtype" placeholder="Name of Customer"  >
                                    <option value="<% out.println(rs.getString("card_type")); %>"><% out.println(rs.getString("card_type")); %></option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" value="<% out.println(rs.getString("card_number")); %>" name="cardnumber" placeholder="Number of Card"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Phone Number</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" value="<% out.println(rs.getString("phonenumber")); %>" name="phonenumber" placeholder="Phone Number"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Address</label>
                            <div class="col-sm-10">
                                <textarea type="text" Class="form-control" name="address" placeholder="Address"   required=""><% out.println(rs.getString("address")); %></textarea>
                            </div>
                          </div>
                        <hr />
                          <div class="form-group">
