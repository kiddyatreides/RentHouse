           ...
           public String autoIDKomen()
            {
                try
                {
                    ...
                    String sql = "select top 1 id_room_type from room_type order by id_room_type desc";
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
					...
					<div class="grid-form1">
                        ...
                        <form class="form-horizontal" method="post" action="AddRoomType">
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">ID Room Type</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" readonly value="<%= autoIDKomen()%>" name="idroomtype" placeholder="Name of Customer"   required=""/>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Name</label>
                            <div class="col-sm-10">
                                <input type="text" Class="form-control" name="nama" placeholder="Name of Room Type"   required=""/>
                            </div>
                          </div>
                        <hr />
                          <div class="form-group">
