 ...
 * @author Kid
 */
public class RentIn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatch = request.getRequestDispatcher("/RentIn.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            obj.setID(idtransaction);
            obj.setIDRoom(idroom);
            ...
            if (res!=0) {
                ...
                response.sendRedirect("ListTransaction");
            } else {
