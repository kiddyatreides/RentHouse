...
public class RentOut extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             RequestDispatcher dispatch = request.getRequestDispatcher("/RentOut.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                System.out.println("GABISA1");
                if (res!= 0) {
                System.out.println("GABISA2");
                //response.sendRedirect("BookAdd?message=Data has been saved");
                System.out.println("GABISA3");
                response.sendRedirect("ListRentOut");
                }
            }
            catch(Exception e){
                System.out.println("GABISA4");
